...
class TestModelSelection(unittest.TestCase):
    ...
    def test_create_training_test_indexes(self):
        ...
        self.assertEqual(result[0][0][0], dt.date(2015, 1, 1))
        self.assertEqual(result[0][0][-1], dt.date(2015, 1, 4))
        self.assertEqual(result[0][1][0], dt.date(2015, 1, 5))
        self.assertEqual(result[0][1][-1], dt.date(2015, 1, 11))
        self.assertEqual(result[1][0][0], dt.date(2015, 1, 1))
        self.assertEqual(result[1][0][-1], dt.date(2015, 1, 11))
        self.assertEqual(result[1][1][0], dt.date(2015, 1, 12))
        self.assertEqual(result[1][1][-1], dt.date(2015, 1, 18))
        result = create_training_test_indexes(dates, 'w', 1)
        self.assertEqual(result[1][0][0], dt.date(2015, 1, 5))
        self.assertEqual(result[1][0][-1], dt.date(2015, 1, 11))
        self.assertEqual(result[1][1][0], dt.date(2015, 1, 12))
        self.assertEqual(result[1][1][-1], dt.date(2015, 1, 18))
