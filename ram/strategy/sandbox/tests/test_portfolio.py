...
class TestPortfolio(unittest.TestCase):
    ...
    def test_update_position_sizes(self):
        ...
        self.assertEqual(self.portfolio.positions['IBM'].daily_pl, -self.comm)
        self.assertEqual(self.portfolio.positions['AAPL'].daily_pl, -2 * self.comm)
        ...
        sizes = {'IBM':0, 'AAPL':0}
        self.portfolio.update_position_sizes(sizes, closes)
        self.portfolio.reset_daily_pl_turnover()
    ...
    def test_get_portfolio_daily_pl(self):
        ...
        self.assertEqual(pl_long, -self.comm)
        self.assertEqual(pl_short, -2 * self.comm)

        closes = {'IBM':101., 'AAPL':49.}
        self.portfolio.update_prices(closes)
        pl_long, pl_short = self.portfolio.get_portfolio_daily_pl()
        self.assertEqual(pl_long, 1. - self.comm)
        self.assertEqual(pl_short, 2. - 2 * self.comm)
